...
export default function Footer() {
  ...
  const quickLinks = [
    ...
    { name: "Services Offered", section: "services" },
  ...
  const socialLinks = [
    {
      icon: Instagram,
      href: "https://www.instagram.com/aarvika_physiotherapy_clinic/",
    },
    {
      icon: Linkedin,
      href: "https://www.linkedin.com/in/pt-rashmi-sakhala-bafana-b75644157/",
    },
  ];
      ...
      <div className='max-w-7xl mx-auto px-4 sm:px-6 lg:px-8'>
        <div className='grid grid-cols-1 md:grid-cols-4 gap-8'>
          <div className='md:col-span-2'>
            ...
            >
              ...
              achieve optimal health and mobility. Expert care with a personal
              touch.
            </p>
          ...
          <div>
            <h4 className='text-lg font-bold mb-4' data-testid='services-title'>
              Services
            </h4>
            <ul className='space-y-2'>
        ...
        <div className='border-t border-background/20 mt-12 pt-8 text-center'>
          <p className='text-background/60' data-testid='footer-copyright'>
            © 2025 Aarvika Physiotherapy Clinic. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
